function changeContent(rt) {
	...
	if (rt == "2") {
		document.getElementById("content_area").innerHTML = '<div class="field"><label for="res_file_name">URL</label><br /><input type="text" id="resource_res_file_name" name="resource[res_file_name]" size="80" maxlength="254"> <span class="instructions"> e.g. http://www.amazon.com</span></div>';
	}
	if (rt == "3") {
